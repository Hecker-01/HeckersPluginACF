    ...
    public void onDefault(@NotNull CommandSender sender, String[] args) {
        if (!sender.hasPermission("heckerspluginacf.command.fly")) {
            ...
            if (player != null) {
                ...
                sender.sendMessage(ChatColor.RED + args[0] + " is not a valid player! - Make sure the player is online!" + ChatColor.RESET + ChatColor.GRAY + " Usage: /smite " + ChatColor.UNDERLINE + "<player>" + ChatColor.RESET);
            }
        }
    }
}
